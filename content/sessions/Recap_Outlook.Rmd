...
- Literate programming & reproducible papers
- Data sharing
...
## TWDNC: Literate programming

Formats for [literate programming](https://en.wikipedia.org/wiki/Literate_programming) that combine text, code, and output, such as:
...
- Curated diccipline-specific archives, such as the [*GESIS Data Archive*](https://www.gesis.org/en/data-services/home), [*PsychArchives*](https://www.psycharchives.org/) by *ZPID*, or [*ICPSR*](https://www.icpsr.umich.edu/web/pages/)
