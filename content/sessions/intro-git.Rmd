...
Test your Git installation. Start the Git Bash and type in<br> `git --version`:
...
.small[
- Create a local Git repo and add a simple text file, e.g., via<br> 
...
- If everything went, uh, well, then you should see the following error 
messsage:<br>
