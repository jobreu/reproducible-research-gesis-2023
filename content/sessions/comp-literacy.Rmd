...
.small[The script `create-project.sh` can be found in `./content/sh/` or, to be more, precise: https://github.com/jobreu/reproducible-research-gesis-2023/tree/main/content/sh]

.small[<div>(Icons made by <a href="https://www.flaticon.com/authors/freepik" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a>)</div>]
...
> "A series of tasks linked to a goal, with a deadline." -- [Tiego Forte](https://fortelabs.com/blog/para)
