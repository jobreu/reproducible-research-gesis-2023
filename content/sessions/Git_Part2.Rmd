...
We have also provided you some toy data that you can use. These are synthetic data based data from the most recently published wave (wave #48 or wave "jc") from the [GESIS Panel](https://www.gesis.org/en/gesis-panel/gesis-panel-home) created using the [synthpop package](https://www.synthpop.org.uk/).

You can find the data and a mini-codebook in the `data` folder within the workshop materials.
...
# Advanced operations with `Git` and *GitHub*
